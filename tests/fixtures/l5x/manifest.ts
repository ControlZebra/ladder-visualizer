...
export const L5X_FIXTURES: readonly L5XFixture[] = [
  {
    ...
    coverage: ['trend', 'trend pen', 'quick watch list', 'watch tag', 'version matrix'],
  },
  {
    ...
    coverage: ['trend', 'trend pen', 'quick watch list', 'watch tag', 'repeated children', 'version matrix'],
  },
  {
    ...
    coverage: ['trend', 'quick watch list', 'empty children', 'omitted optionals', 'version matrix'],
  },
  {

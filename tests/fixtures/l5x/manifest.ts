...
export const L5X_FIXTURES: readonly L5XFixture[] = [
  ...
  {
    id: 'normalization-coverage-v33',
    file: 'normalization-coverage-v33.L5X',
    studio5000Version: '33.00',
    targetType: 'Controller',
    ...
    coverage: [
      ...
      'program local tag',
      'AOI decorated array default',
      'AOI decorated structure default',
      'AOI mixed decorated child order',
      'AOI multidimensional local tag',
      'partial diagnostic',
      'version matrix',
    ],
  },
  {
    id: 'normalization-coverage-v34',
    file: 'normalization-coverage-v34.L5X',
    studio5000Version: '34.01',
    targetType: 'Controller',
    artifactKind: 'controller',
    profiles: ['rockwell-full-project'],
  ...
  {
    id: 'normalization-coverage-v35',
    file: 'normalization-coverage-v35.L5X',
    studio5000Version: '35.01',
    targetType: 'Controller',
    artifactKind: 'controller',
    profiles: ['rockwell-full-project'],
  ...
  },
  {
    ...
    coverage: [
      ...
      'decorated scalar',
      'decorated array',
      'L5K array and structure tag values',
  ...
  {
    id: 'aoi-interface-metadata-v33',
    file: 'aoi-interface-metadata-v33.L5X',
    studio5000Version: '33.00',
    targetType: 'AddOnInstructionDefinition',
    artifactKind: 'add-on-instruction',
    profiles: ['rockwell-controller-rll'],
    expectedParseStatus: 'complete',
    sourceCounts: { ...emptySourceCounts, controllers: 1, aois: 1, parameters: 3, localTags: 2 },
    currentParser: {
      success: true,
      normalizedCounts: { ...emptyNormalizedCounts, aois: 1, aoiParameters: 3, aoiLocalTags: 2 },
    },
    coverage: ['AOI parameter comments', 'AOI parameter Constant', 'AOI local-tag comments', 'metadata omission', 'version matrix'],
  },
  {
    id: 'aoi-interface-metadata-v34',
    file: 'aoi-interface-metadata-v34.L5X',
    studio5000Version: '34.01',
    targetType: 'AddOnInstructionDefinition',
    artifactKind: 'add-on-instruction',
    profiles: ['rockwell-controller-rll'],
  ...
  {
    id: 'aoi-interface-metadata-v35',
    file: 'aoi-interface-metadata-v35.L5X',
    studio5000Version: '35.01',
    targetType: 'AddOnInstructionDefinition',
    artifactKind: 'add-on-instruction',
    profiles: ['rockwell-controller-rll'],
